...
import 'package:cash_register/modules/cart_summary_module/cart_summary_item_details_widget.dart';
...
class _CartItemWidgetState extends State<CartItemWidget> {
  ...
  void increaseProductCount(int productId) async {
    ...
    // dbs.increaseProductCount(productId).then((_) async {
    //   StreamHelper.cartCountSink.add(await dbs.getCartCount());
    // });
    await dbs.increaseProductCount(productId);
  }

  void updatPrice() async {
    final dbs = DatabaseService.instance;
    await dbs.changePrice(widget.productId, priceEditContoller.text.toString());
  }
  ...
  void loadCartProduct() async {
    ...
    Future<Map<String, dynamic>> data =
        dbs.getCartProductById(widget.productId);
        ...
        child: Row(
          ...
          children: [
            ...
            CartSummaryItemDetailsWidget(
                productId: widget.productId, cartItem: widget.cartItem)
            ...
            //         children: [
            //           Text(
            //             inrFormat.format(double.parse(widget.cartItem.price)),
            ...
            //             widget.cartItem.countNumber, widget.cartItem.price))),
